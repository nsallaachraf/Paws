...
## [Settings](https://github.com/nsallaachraf/Paws/blob/main/.env-example)
...
## Installation
You can download the [**repository**](https://github.com/nsallaachraf/Paws) by cloning it to your system and installing the necessary dependencies:
```shell
git clone https://github.com/nsallaachraf/Paws.git
cd Paws
```
